...
class EmployeeExperience(models.Model):
    ...
    company1salary = models.CharField(max_length=200,null=True)
    ...
    company2salary = models.CharField(max_length=200,null=True)
    ...
    company3salary = models.CharField(max_length=200,null=True)
